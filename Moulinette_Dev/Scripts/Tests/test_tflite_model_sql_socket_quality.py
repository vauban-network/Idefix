...
# Paths
safe_payload_file_path = './Scripts/Tests/Samples/sql-safe-list.txt'  # Path to the SQL safe payload file
malicious_payload_file_path = './Scripts/Tests/Samples/sql-payload-list.txt'  # Path to the SQL malicious payload file
