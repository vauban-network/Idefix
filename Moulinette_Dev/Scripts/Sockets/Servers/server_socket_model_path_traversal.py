...
from _conf import HEART_XSS_IP, HEART_XSS_PORT, HEART_XSS_PARANOIA, HEART_PATH_TRAVERSAL_PORT, HEART_PATH_TRAVERSAL_PARANOIA, HEART_PATH_TRAVERSAL_IP
...
tflite_model_path = './IA/Models/model_path_traversal_lite.tflite'  # Utiliser le modèle optimisé TFLite
